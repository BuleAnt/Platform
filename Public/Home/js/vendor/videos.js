...
(function() {
    ...
    s.R = function(a, c) {
        ...
        this.N.push(d);
        "function" === typeof d.id && (this.Qa[d.id()] = d); (e = e || d.name && d.name()) && (this.Ra[e] = d);
    ...
    s.removeChild = function(a) {
        ...
        if (a && this.N) {
            for (var c = l,
            d = this.N.length - 1; 0 <= d; d--) if (this.N[d] === a) {
                c = f;
                this.N.splice(d, 1);
                break
            }
    ...
    for (var K = 0; K < t.F.Sa.length; K++) t.F[t.F.Sa[K]] = K,
    t.F.prototype[t.F.Sa[K]] = K;
    var L, M, N, O;
    ...
    t.Player = t.a.extend({
        i: function(a, c, d) {
            ...
            function() {
                this.qa && (this.qa = l, this.userActive(f), clearTimeout(j), j = setTimeout(t.bind(this,
                function() {
    ...
    function da(a) {
        ...
        if (a.hasChildNodes()) {
            ...
            "source" === e ? c.sources.push(t.Aa(d)) : "track" === e && c.tracks.push(t.Aa(d))
        }
        return c
    }
    s.e = function() {
    ...
    s.Nd = function() {
        this.error(k);
        this.paused() ? (Q(this, l), this.X("play",
        function() {
            Q(this, f)
        })) : this.m("firstplay")
    };
    ...
    function R(a, c) {
        if (a.k && a.k.ma) try {
            ...
            throw a.k[c] === b ? t.log("Video.js: " + c + " method not defined for " + a.fb + " playback technology.", d) : "TypeError" == d.name ? (t.log("Video.js: " + c + " unavailable on " + a.fb + " playback technology element.", d), a.k.ma = l) : t.log(d),
            d;
        }
    }
    s.play = function() {
    ...
    s.userActive = function(a) {
        return a !== b ? (a = !!a, a !== this.Sb && ((this.Sb = a) ? (this.qa = f, this.q("vjs-user-inactive"), this.n("vjs-user-active"), this.m("useractive")) : (this.qa = l, this.k && this.k.X("mousemove",
        function(a) {
            a.stopPropagation();
            a.preventDefault()
    ...
    t.ja.prototype.e = function() {
        return t.t.prototype.e.call(this, "div", {
            ...
            innerHTML: '<div><span class="vjs-control-text">' + this.s("Mute") + "</span></div><div id='vertical-slider' style='height: 200px;z-index:99;margin-top: -200px;'></div>"
        })
    };
    ...
    t.u = t.a.extend({
        i: function(a, c, d) {
            ...
            c.Hc = l;
            t.a.call(this, a, c, d);
            this.o.progressEvents || (this.zc = f, this.Ec = setInterval(t.bind(this,
            function() {
            ...
            this.o.timeupdateEvents || (this.Lb = f, this.j().d("play", t.bind(this, this.Pc)), this.j().d("pause", t.bind(this, this.eb)), this.X("timeupdate",
            function() {
    ...
    s.Pc = function() {
        this.mc && this.eb();
        this.mc = setInterval(t.bind(this,
        function() {
            this.j().m("timeupdate")
        }), 250)
    };
    ...
    t.f = t.u.extend({
        i: function(a, c, d) {
            ...
            t.Xc && this.J(function() {
                t.d(this.w(), "mousemove", t.bind(this,
                function() {
                    this.j().m({
                        type: "mousemove",
                        bubbles: l
    ...
    function Y(a, c, d) {
        ...
        h = e.length,
        j, n; g < h; g++) j = e[g],
        j.id() === c ? (j.show(), n = j) : d && (j.K() == d && 0 < j.mode()) && j.disable(); (c = n ? n.K() : d ? d: l) && a.m(c + "trackchange")
    }
    t.C = t.a.extend({
        i: function(a, c) {
            t.a.call(this, a, c);
    ...
    s.xa = function() {
        for (var a = this.c.textTracks(), c = 0, d = a.length, e, g, h = this.O = []; c < d; c++) if (e = a[c], e.K() == this.H) if (0 === e.readyState()) e.load(),
        e.d("loaded", t.bind(this, this.xa));
        else {
            g = e;
            break
        }
    ...
    "complete" === document.readyState ? t.Tc = f: t.X(window, "load",
    function() {
        t.Tc = f
    });
    t.vb();
